...
class ZoneEditDialog:
	...
	def draw(self, screen):
		...
		prompt = self.font.render("Press Enter to switch field, S to save", True, (200, 200, 200))
...
while running:
	...
	for zone in zones:
		...
		if zone.type == "live_feed":
			live_rect = pygame.Rect(zone_x, zone.rect.y, zone.rect.width, zone.rect.height)
