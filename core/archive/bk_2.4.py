...
class CursorSprite(pygame.sprite.Sprite):
	...
	def update(self, mouse_y):
		self.rect.centery = max(0, min(screen_height, mouse_y))
...
class ConfirmationDialog:
	def __init__(self, message):
		...
		self.surface = pygame.Surface((400, 150))
...
cursor_group = pygame.sprite.Group(cursor_sprite)
